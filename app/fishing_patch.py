...
def patch_engine() -> None:
    ...
    fishing_import = "from app.routes.fishing import select_fishing_action\n"
    if fishing_import not in source:
...
'''
    ...
    if "Fishing waiting. kind=%s" not in source and semi_auto_anchor in source:
        source = source.replace(
            semi_auto_anchor,
